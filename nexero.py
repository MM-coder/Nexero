...
async def rulessetup(ctx):
    if ctx.message.author.id == '279714095480176642':
        ...
        embed.add_field(name="Use english in all channels unless stated otherwise", value="Makes it easier for staff to moderate chat")
        embed.add_field(name="Don't be annoying ", value="Includes minimoding and treating other users/staff unniceley")
        embed.add_field(name="Don't undo what a staff member has done ", value="Name changes, etc")
        embed.add_field(name="False/ Spam pings", value="Like ghost pinging, pinging staff for your meme, etc")
        embed.add_field(name="Spamming of any sort", value="Includes Character Spam, Flooding Chat, Emoji Spam, Reaction Spam and ASCII text")
        medsev = discord.Embed(color =0xffa500, title = "Medium Severity Kick and or Ban]")
        embed.add_field(name="Advertising of any sort", value="Servers (Inc DM), Products, etc")
        embed.add_field(name="Selfbotting", value="Its against the TOS don't do it.")
        embed.add_field(name="Sharing of illegal or false information", value="Untrue Rumors, etc")
        maxserv = discord.Embed(color =0xff0000, title = "High serverity [Permanent Ban]")
        embed.add_field(name="Sending NSFW ", value="Porn, Hentai, boobs, etc")
        embed.add_field(name="Alts", value="We don't know what you do with them.")
        embed.add_field(name="Sending files or programs that can damage another user's device", value="Viruses, Trojans, Adware, etc")
        embed.add_field(name="Raiding", value="Ban and report to discord's trust and saftey team")
        embed.add_field(name="Racism, Homofobia", value="We **must** respect everyone independent of race, sexuallity or country of residance")
        await bot.say(lowsev=embed)
        await bot.say(medsev=embed)
        await bot.say(maxsev=embed)
    else:
